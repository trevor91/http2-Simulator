...
def __LoadEntity(url, urlopen=urllib.request.urlopen):
...
""" check finish browser rendering
url_list=[]
url_list.append("161031_Y9_QT9")
batch_json = CheckBatchStatus(url_list)
batch_json = json.dumps(batch_json)
batch_json = json.loads(batch_json)
print(batch_json["161031_Y9_QT9"])
"""
